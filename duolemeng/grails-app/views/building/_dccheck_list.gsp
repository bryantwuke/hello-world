<script>
    gloabal_change_symbol = 0;

    function fmt_event_opt(fields) {

        var fmtstr ="<a href='javascript:void(0)' onclick='func_dc_view2(" + fields[0] + ", \"查看\"); return false;'>查看</a>";

        if(fields[1] == ${roomsale.Enum_Discounttype.DT_discount_wait.code}){ //优惠
            fmtstr ="<a href='javascript:void(0)' onclick='func_dc_view(" + fields[0] + ", \"查看\"); return false;'>查看</a>";
            fmtstr +="<a href='javascript:void(0)' onclick='func_dc_set(" + fields[0] + ",\"设置通过审核\", \"${roomsale.Enum_Discounttype.DT_discount_ok.code}\","+fields[2] +"," + fields[3] + "); return false;' style='margin-left:1em;'>审核通过</a>";
            fmtstr +="<a href='javascript:void(0)' onclick='func_dc_set(" + fields[0] + ",\"设置不通过审核\", \"${roomsale.Enum_Discounttype.DT_discount_no.code}\","+fields[2] +"," + fields[3] + "); return false;' style='margin-left:1em;'>审核不通过</a>";
        }
    ...
    function func_dc_view(id) {
        func_ajaxdlgview("building/discount_viewlog", "discount", id, "查看优惠");
    }

    function func_dc_view2(id) {
        func_ajaxdlgview2("building/discount_viewlog", "discount", id, "查看优惠");
    }
...
<div data-dojo-type="dijit/layout/TabContainer" style="height: 24em; width: 100%" tabPosition="top" id="dctabs">
    <div data-dojo-type="dijit/layout/ContentPane" data-dojo-props='title:"待审核"' onshow="tablistener();" id="todo">

        <div data-dojo-type="dojox/data/QueryReadStore" data-dojo-id="ds_discount_list_todo"
             data-dojo-props="url:'building/ds_discount_list?dc_type=${roomsale.Enum_Discounttype.DT_discount_wait.code}&reftype=${dcins.reftype}&refid=${dcins.refid}'">
        </div>
    ...
    <div data-dojo-type="dijit/layout/ContentPane" data-dojo-props='title:"审核通过"' id="ok">
        <div data-dojo-type="dojox/data/QueryReadStore" data-dojo-id="ds_discount_list_ok"
             data-dojo-props="url:'building/ds_discount_list?dc_type=${roomsale.Enum_Discounttype.DT_discount_ok.code}&reftype=${dcins.reftype}&refid=${dcins.refid}'">
        </div>
    ...
    <div data-dojo-type="dijit/layout/ContentPane" data-dojo-props='title:"审核失败"' id="no">
        ...
        <div data-dojo-type="dojox/data/QueryReadStore" data-dojo-id="ds_discount_list_no"
             data-dojo-props="url:'building/ds_discount_list?dc_type=${roomsale.Enum_Discounttype.DT_discount_no.code}&reftype=${dcins.reftype}&refid=${dcins.refid}'">
        </div>
