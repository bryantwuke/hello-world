...
<head>
    ...
    %{--${resource(dir: "fonts/", file: "weather.png")}--}%
    ...
    body {
        ...
        border: 0;
        margin: 0;
        background: url('${resource(dir: "images/", file: "bg.jpg")}') repeat;
...
background: #DDF1FE;width: 40em;height: 22em;border: 1px solid #000;">
    ...
    <div style="background: url('${resource(dir: "images/", file: "login_bg.jpg")}') repeat-x;
    ...
    <button data-dojo-id="btn_login" data-dojo-type="dijit/form/Button"
        ...
        <img src='${resource(dir: "images/", file: "login_button.gif")}' alt="登录"/>
    </button>
    %{--<br>--}%
